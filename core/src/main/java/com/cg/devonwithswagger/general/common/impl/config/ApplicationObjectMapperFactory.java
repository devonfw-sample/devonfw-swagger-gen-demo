package com.cg.devonwithswagger.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the DevonWithSwagger application.
 */
